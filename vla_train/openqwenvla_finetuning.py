...
class TrainingConfig:
    def __init__(
        ...
        data_root_dir: str = "FINETUNING_DATA_ROOT_DIR",
        data_mix: str = "DATA_MIX_TYPE", ## For this, please check out the data mix in ./datasets/rlds/oxe/mixtures.py
...
def load_model_and_processor(config: TrainingConfig, accelerator: Accelerator):
    ...
    act_max = processor.tokenizer.convert_tokens_to_ids("<robot_action_2047>")
...
def train(config: TrainingConfig):
    ...
    # Training loop
    # Right now we assume single node training. 
