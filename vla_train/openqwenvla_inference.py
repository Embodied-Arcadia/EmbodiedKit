...
class OpenQwenVLA:
    ...
    def __init__(
        ...
        try:
            ...
            self._ACTION_TOKEN_MIN = self.processor.tokenizer.convert_tokens_to_ids("<robot_action_0>")
            self._ACTION_TOKEN_MAX = self.processor.tokenizer.convert_tokens_to_ids("<robot_action_2047>")
